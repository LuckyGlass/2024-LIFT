...
#SBATCH -o logs/%j-LooGLE-ShortQA-GatedMemory-QA10-SiC.out.log
#SBATCH -e logs/%j-LooGLE-ShortQA-GatedMemory-QA10-SiC.err.log
#SBATCH -c 1

python scripts/test_loogle.py \
    --input_file datasets/loogle/shortdep_qa.jsonl \
    --output_file outputs/LooGLE-ShortQA-GatedMemory-QA10-SiC.jsonl \
    --overwrite True \
    --num_syn_qa 10 \
