...
#SBATCH -o logs/%j-LooGLE-ShortQA-GatedMemory-QA10.out.log
#SBATCH -e logs/%j-LooGLE-ShortQA-GatedMemory-QA10.err.log
#SBATCH -c 1

python scripts/test_loogle.py \
    --input_file datasets/loogle/shortdep_qa.jsonl \
    --output_file outputs/LooGLE-ShortQA-GatedMemory-QA10.jsonl \
    --overwrite True \
    --num_syn_qa 10 \
    --title_option 1 \
