...
#SBATCH -o logs/%j-LooGLE-ShortQA-GatedMemory-CoT.out.log
#SBATCH -e logs/%j-LooGLE-ShortQA-GatedMemory-CoT.err.log
#SBATCH -c 1

python scripts/test_loogle.py \
    --input_file datasets/loogle/shortdep_qa.jsonl \
    --output_file outputs/LooGLE-ShortQA-GatedMemory-CoT.jsonl \
    --overwrite True \
    --num_syn_qa 0 \
    --use_cot True \
    --num_test 50 \
