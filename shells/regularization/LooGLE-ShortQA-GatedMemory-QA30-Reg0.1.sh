...
#SBATCH -o logs/%j-LooGLE-ShortQA-GatedMemory-QA30-Reg0.1.out.log
#SBATCH -e logs/%j-LooGLE-ShortQA-GatedMemory-QA30-Reg0.1.err.log
#SBATCH -c 1

python scripts/test_loogle.py \
    --input_file datasets/loogle/shortdep_qa.jsonl \
    --output_file outputs/LooGLE-ShortQA-GatedMemory-QA30-Reg0.1.jsonl \
    --overwrite True \
    --num_syn_qa 30 \
