...
#SBATCH -o logs/%j-LooGLE-ShortQA-GatedMemory-QA10-CoT-Reg1.0.out.log
#SBATCH -e logs/%j-LooGLE-ShortQA-GatedMemory-QA10-CoT-Reg1.0.err.log
#SBATCH -c 1

python scripts/test_loogle.py \
    --input_file datasets/loogle/shortdep_qa.jsonl \
    --output_file outputs/LooGLE-ShortQA-GatedMemory-QA10-CoT-Reg1.0.jsonl \
    --overwrite True \
    --num_syn_qa 10 \
