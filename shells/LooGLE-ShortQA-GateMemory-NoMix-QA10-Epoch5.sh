...
#SBATCH -o logs/%j-LooGLE-ShortQA-GateMemory-NoMix-QA10-Epoch5.out.log
#SBATCH -e logs/%j-LooGLE-ShortQA-GateMemory-NoMix-QA10-Epoch5.err.log
#SBATCH -c 1

python scripts/test_loogle.py \
    --input_file datasets/loogle/shortdep_qa.jsonl \
    --output_file outputs/LooGLE-ShortQA-GateMemory-NoMix-QA10-Epoch5.jsonl \
    --overwrite True \
    --num_syn_qa 10 \
